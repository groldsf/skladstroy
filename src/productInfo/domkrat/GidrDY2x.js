export default{
    ...
    html:"<div class=\"btp-detail-desc\">\n" +
        ...
        "\t\t\t\t<div>\n" +
        "\t\t\t\t<p><span style=\"font-family: Arial; font-size: 12px; line-height: 18px; background-color: #ffffff;\">В гидроцилиндрах домкратов данного типа рабочее давление подводится через два независимых трубопровода, поэтому поршень может передавать нагрузку в обоих направлениях. Домкраты ДУ предназначены для подъема, перемещения грузов, а также могут применяться в качестве силового органа в различных устройствах и механизмах.</span></p>\n" +
        "<p>&nbsp;</p>\n" +
        "<table border=\"0\" style=\"height: 101px; width: 763px;\">\n" +
        "<tbody>\n" +
        "<tr>\n" +
        ...
        "<td style=\"text-align: center;\"><strong>374</strong></td>\n" +
